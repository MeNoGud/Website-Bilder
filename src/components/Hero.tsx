      ...
      <section className="relative z-10 flex min-h-screen flex-col overflow-visible">
        <HeroScrollSlew>
          ...
          <div className="relative grid min-h-screen w-full grid-rows-[1fr_auto_1fr]">
            ...
            <div
              className="hero-tag col-span-full row-start-3 mx-auto flex w-full max-w-6xl flex-col items-center px-6 pb-[clamp(3rem,6vw,8rem)] pt-[calc(clamp(4.25rem,13vw,6.75rem)+30px)] text-center sm:px-10"
            >
              <p
