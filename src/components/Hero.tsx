...
export function Hero() {
  return (
    <section
      ...
      style={{
        background: [
          // Cream oval behind watermark so multiply blend stays correct
          "radial-gradient(ellipse 55% 45% at 50% 46%, #F4EEE4 0%, #F4EEE4 38%, transparent 72%)",
          // Subtle warm accent blobs
          "radial-gradient(ellipse at 20% 50%, rgba(232,36,0,0.06) 0%, transparent 50%)",
          "radial-gradient(ellipse at 85% 15%, rgba(245,162,0,0.04) 0%, transparent 50%)",
          // Celeste base
          "#4DB8D4",
        ].join(", "),
      }}
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(0,60,90,0.10) 0%, transparent 65%)" }}
        aria-hidden
      />
