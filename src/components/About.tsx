        ...
        <div className="mt-14 grid gap-12 lg:grid-cols-[1fr_300px] lg:gap-20">
          ...
          <div className="reveal rounded-2xl border border-void-border bg-void-surface p-7">
            <ul className="space-y-5">
              <li>
                <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-gold">Speciality</span>
              ...
              <li className="border-t border-void-border pt-5">
                <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-gold">Background</span>
              ...
              <li className="border-t border-void-border pt-5">
                ...
                <p className="mt-1.5 font-sans text-[13px] text-cream-muted">{site.location} · Working globally</p>
              </li>

              <li className="border-t border-void-border pt-5">
                <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-gold">Stack</span>
                <div className="mt-3 flex flex-wrap gap-2">
                  {["Next.js", "React", "TypeScript", "Tailwind CSS", "Framer Motion"].map((tag) => (
                    <span
                      key={tag}
